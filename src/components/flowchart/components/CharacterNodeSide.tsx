...
const CharacterNodeSide: React.FC<CharacterNodeProps> = (props) => {
    const { data } = props;
    ...
    return (
        <div className="character-node-side">
            <img
                className="character-node-side--image"
                src={getLocalFilePath(_image?.ref)}
                alt={_image.alt}
                onError={handleImageError}
            />
            <div
                className="character-node-side--name"
                style={{
            ...
            >
                ...
                <Handle
                    ...
                    className="character-node-side--handle handle-mother"
                />
                <Handle
                    type="target"
                    position={Position.Top}
                    id={`center-top-handle-${data.id}`}
                    className="character-node-side--handle handle-center"
                />
                <Handle
                    type="target"
                    position={Position.Top}
                    id={`father-top-handle-${data.id}`}
                    className="character-node-side--handle handle-father"
                />
                <Handle
                    type="target"
                ...
                <Handle
                    ...
                    className="character-node-side--handle handle-right"
                />
            </div>
        </div>
    );
...
export default CharacterNodeSide;
